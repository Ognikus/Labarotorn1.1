...
public class Main {
    ...
    public static void Task11(){
        Task11Reh Task_11 = new Task11Reh();
    }

    public static void Task12(){
        Task12Reh Task_12 = new Task12Reh();
    }
    ...
    public static void main(String[] args) {
        ...
        while (f){
            ...
            System.out.println("-----------------------------------------------------------------------------------------------");
            System.out.println("""
                    1.Ввести n строк с консоли, найти самую короткую строку. Вывести эту строку и ее длину.\s
                    ...
                    3.Ввести n строк с консоли. Вывести на консоль те строки, длина которых меньше средней, также их длины.\s
